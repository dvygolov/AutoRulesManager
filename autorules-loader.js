(function autoRulesManagerLoader(config) {
  "use strict";

  const loaderConfig = Object.assign({
    app: "AutoRulesManager",
    manifestUrl: "https://autorulesmanager.pages.dev/autorules/latest/manifest.html",
    embeddedManifest: null,
    cacheKey: "autorulesmanager.loader.cache.v1",
    timeoutMs: 45000,
  }, config || {});
  const guardKey = "__AutoRulesManagerLoader";
  ...
  const executePayload = (source, build) => new Promise((resolve, reject) => {
    const blob = new Blob([
      source,
      `\n//# sourceURL=autorulesmanager://${build}/payload.js`,
